 ...
 */
static asn_per_constraints_t asn_PER_type_E2AP_RICcontrolAckRequest_constr_1 CC_NOTUSED = {
...
static const asn_INTEGER_specifics_t asn_SPC_E2AP_RICcontrolAckRequest_specs_1 = {
