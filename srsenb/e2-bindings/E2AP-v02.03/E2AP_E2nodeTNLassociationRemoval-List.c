...
static asn_per_constraints_t asn_PER_type_E2AP_E2nodeTNLassociationRemoval_List_constr_1 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 5,  5,  1,  32 }	/* (SIZE(1..32)) */,
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_E2AP_E2nodeTNLassociationRemoval_List_1[] = {
	{ ATF_POINTER, 0, 0,
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_E2AP_ProtocolIE_SingleContainer_1999P10,
		0,
		{ 0, 0, 0 },
...
static asn_SET_OF_specifics_t asn_SPC_E2AP_E2nodeTNLassociationRemoval_List_specs_1 = {
